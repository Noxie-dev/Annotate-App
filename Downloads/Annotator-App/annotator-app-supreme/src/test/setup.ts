...
(global as any).RTCPeerConnection.generateCertificate = vi.fn().mockResolvedValue({});
...
// Add missing supportedLocalesOf method
(global as any).Intl.DateTimeFormat.supportedLocalesOf = vi.fn().mockReturnValue([]);
